...
<?php include('components/head.inc.php'); ?>
    <title>AutoCAD ETA Tutorials | 3D Modeling & Design</title>
</head>
<?php include('components/header.inc.php'); ?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            ...
                            <ul class="breadcrumb-bg">
                                ...
                                <a href="AutoCADETA.php"><li>Erovoutika Training Area Tutorials</li> </a>                               
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="reviews-area review-page-area page-padding-2">
            ...
            <div class="title9 text-center">
                    <span>AutoCAD: Erovoutika Training Area Tutorials</span>
            </div>
            </div>
        </div>
        <div class="row">
