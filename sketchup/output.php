            ...
            <div class="pricing-content">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="outputs/installation.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="pri_table_list">
                        <div class="top-price-inner">
                            <div class="rates">
                                <span class="software"><strong>SketchUp 3D</strong></span>
                                <span class="software"><strong>Design Software</strong></span>
                                <span class="topic"><strong>Project</strong></span>
                                <span class="topic"><strong>Outputs</strong></span>
                            </div>
                        </div>
                        <div class="view-btn">
                            <a class="view-btn" href="outputs/project.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="outputs/building.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="outputs/highschool.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
