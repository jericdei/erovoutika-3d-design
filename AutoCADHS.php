...
<?php include('components/head.inc.php'); ?>
    <title>AutoCAD High School Tutorials | 3D Modeling & Design</title>
</head>
<?php include('components/header.inc.php'); ?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            ...
                            <ul class="breadcrumb-bg">
                                ...
                                <a href="AutoCADvideo.php"><li class="home-bread">AutoCAD</li> </a>
                                <a href="AutoCADHS.php"><li >High School Level Tutorials</li> </a>                               
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="reviews-area review-page-area page-padding-2">
            ...
            <div class="title9 text-center">
                    <span>AutoCAD: High School Level Tutorials</span>
            </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="single-testi">
                                <div class="testi-text">
                                    <div class="clients-text">
                                        ...
                                        <p><span><strong>Details:</strong></span> CPU Fan</p>
                            ...
                            <div class="single-testi">
                                <div class="testi-text">
                                    <div class="clients-text">
                                        ...
                                        <p><span><strong>Details:</strong></span> CPU Heat Sink</p>
                                        <p><span><strong>Created by:</strong></span> Rhea Ariola</p>
                                        <div class="slide-content1">
                                        <div class="video-content">
                            ...
                            <div class="single-testi">
                                <div class="testi-text">
                                    <div class="clients-text">
                                        ...
                                        <p><span><strong>Details:</strong></span> Capacitor</p>
                                        <p><span><strong>Created by:</strong></span> Rhea Ariola</p>
                                        <div class="slide-content1">
                                        <div class="video-content">
