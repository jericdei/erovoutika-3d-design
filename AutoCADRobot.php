...
<head>
    ...
    <title>AutoCAD Robot Design Tutorials | 3D Modeling & Design</title>
</head>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb text-center">
                    <div class="section-headline white-headline">
                        <h3 class="title5">Video Tutorials: <span>Robot Design Tutorials </span></h3>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="title9 text-center">
                    <span>AutoCAD: Robot Design Tutorials</span>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="single-testi">
                        <div class="testi-text">
                            <div class="clients-text">
                                ...
                                <p><span><strong>Details:</strong></span> </p>
                                <p><span><strong>Created by:</strong></span> Gracely Mae Fampulme</p>
                                <div class="slide-content1">
                                    <div class="video-content">
                                        <a href="#" class="video-play vid-zone">
                                            <i class="fa fa-play"></i>
