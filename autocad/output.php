...
<head>
    ...
    <title>AutoCAD Outputs | 3D Modeling & Design</title>
</head>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb text-center">
                    <div class="section-headline white-headline">
                        <h3 class="title5">Outputs: <span>AutoCAD</span></h3>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/installation.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/mrt.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/lrt.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/eta.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pricing-content">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/mechanical.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/floorplan.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/railtrack.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/lighting.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/elementary.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/highschool.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="price-btn blue">
                            <a class="blue" href="outputs/college.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
