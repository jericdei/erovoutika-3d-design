            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb text-center">
                    <div class="section-headline white-headline">
                        <h3 class="title5">Outputs: <span>AutoCAD Software Installation</span></h3>
                    </div>
                        ...
                        <div class="testi-text">
                            <div class="clients-text">
                                ...
                                <div class="slide-content1">
                                    <div class="pdf-btn">
                                        <a class="video-play vid-zone" href="https://drive.google.com/file/d/1o-PnHI73wqqWboHZoCpZDvhj2i-9gRts/preview"><img class="pdf-ppt-icon" src=/img/logo/pdf-icon.png> PDF Instructional</a>
                                    </div> <!-- End pdf-btn -->
                                    <div class="pdf-btn">
                    ...
                    <div class="single-testi">
                        <div class="testi-text">
                            <div class="clients-text">
                                ...
                                <div class="slide-content1">
                                    <div class="pdf-btn">
                                        <a class="video-play vid-zone" href="https://drive.google.com/file/d/1qcW7CY4gsudPaIi9Y-CN3pjOZeA9S_OM/preview"><img class="pdf-ppt-icon" src=/img/logo/pdf-icon.png> PDF Instructional</a>
                                    </div> <!-- End pdf-btn -->
                                    <div class="pdf-btn">
                                        <a class="video-play vid-zone" href=""><img class="pdf-ppt-icon" src=/img/logo/pdf-icon.png> PDF Creative</a>
                                    </div> <!-- End pdf-btn -->
                    ...
                    <div class="single-testi">
                        <div class="testi-text">
                            <div class="clients-text">
                                ...
                                <div class="slide-content1">
                                    <div class="pdf-btn">
                                        <a class="video-play vid-zone" href="https://drive.google.com/file/d/1_XLB5HvGMmwD9im4cOhjZ1k95WUNWyrm/preview"><img class="pdf-ppt-icon" src=/img/logo/pdf-icon.png> PDF Instructional</a>
                                    </div> <!-- End pdf-btn -->
                                    <div class="pdf-btn">
                                        <a class="video-play vid-zone" href=""><img class="pdf-ppt-icon" src=/img/logo/pdf-icon.png> PDF Creative</a>
                                    </div> <!-- End pdf-btn -->
