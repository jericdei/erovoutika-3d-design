...
<head>
    ...
    <title>AutoCAD Video Tutorials | 3D Modeling & Design</title>
</head>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb text-center">
                    <div class="section-headline white-headline">
                        <h3 class="title5">Video Tutorials: <span>AutoCAD</span></h3>
                    </div>
            ...
            <div class="pricing-content">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/installation.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/mrt.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/lrt.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/eta.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pricing-content">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/robot.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/floorplan.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/railtrack.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/lighting.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/elem.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/highschool.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="pri_table_list">
                        ...
                        <div class="view-btn">
                            <a class="view-btn" href="videos/college.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
