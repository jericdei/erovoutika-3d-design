            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb text-center">
                    <div class="section-headline white-headline">
                        <h3 class="title5">Outputs: <span>AutoCAD College Level Tutorial Outputs</span></h3>
                    </div>
                    <ul class="breadcrumb-bg">
                        ...
                        <a href="AutoCADCollegeOutput.php">
                            <li>College Level Tutorials Outputs</li>
                        </a>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="title9 text-center">
                    <span>3D Design Software: AutoCAD College Level Tutorial Outputs</span>
                </div>
            </div>
        </div>
        <div class="row">
